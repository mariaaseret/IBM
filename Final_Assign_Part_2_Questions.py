...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        average_sales = recession_data.groupby('Vehicle_Type', 'unemployment_rate')['Automobile_Sales'].mean().reset_index()                         
        R_chart4  = dcc.Graph(
            figure=px.bar(average_sales,
                x='Vehicle_Type',
                y='Automobile_Sales',
...
# Plot bar chart for average number of vehicles sold during the given year
        ...
        Y_chart3 = dcc.Graph(
            figure=px.bar(avr_vdata, 
                x='Vehicle_Type', 
                y='Automobile_Sales', 
                title='Vehicles Sold per Year by Vehicle Type'
                )
        )
...
# Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(
            figure=px.pie(exp_data, 
                ...
                names='Vehicle_Type', 
                title='Yearly Advertisement Expenditure by Vehicle Type'
                )
        )
